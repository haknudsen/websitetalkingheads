...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="914" height="471" id="FlashID" title="Main Carousel">
  ...
  <!--[if !IE]>-->
  <object type="application/x-shockwave-flash" data="carousel.swf" width="914" height="471">
    <!--<![endif]-->
    <param name="quality" value="high" />
    <param name="FlashVars" value="xml=backgrounds.xml"/>
    <param name="wmode" value="opaque" />
    <param name="swfversion" value="11.0.0.0" />
    <param name="expressinstall" value="../Scripts/expressInstall.swf" />
...
<div class="featuredactors text-center"><a href="motionbackgrounds.php">Return to main backgrounds</a></div>
</div>
