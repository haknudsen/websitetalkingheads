...
<div id="containerExample">
  ...
  <div class="exampleArea">
    <h3 class="exampleTitle"><a href="http://www.websitetalkingheads.com/videopresentations/custompresentations.php">Custom Presentations</a></h3>
    <div class="example-prices">
      <h4 class="hidden">Prices and Benifits</span></h4>
      <h4>Video Presentation</h4>
      <ul>
        <li>Live Spokesperson</li>
        <li>Editing and Motion Graphics</li>
        <li>Lots of Images and Effects</li>
      </ul>
      <h5 id="smallScript">Starting at Just</h5>
      <h6>$799</h6>
    </div>
  ...
  <div class="exampleArea">
    ...
    <div class="example-prices">
      <h4 class="hidden">Prices and Benifits</span></h4>
      <h4>Virtual Sets<br />Video</h4>
      <ul>
        <li>Live Spokesperson</li>
        <li>Choose From over 20 Sets</li>
        <li>4 Product or Services Images</li>
      </ul>
      <h5 id="smallScript">Starting at Just</h5>
      <h6>$399</h6>
    </div>
  ...
  <div class="exampleArea">
    ...
    <div class="example-prices">
      ...
      <ul>
        <li>Collaborative Scripting</li>
        <li>Creative Storyboarding</li>
        <li>Custom Drawings</li>
      </ul>
      <h5><a href="tel://801-748-2281" title="Give us a call.">Call for Pricing</a></h5>
    </div>
