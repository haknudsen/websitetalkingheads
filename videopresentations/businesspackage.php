...
<h2>Video Presentation- Business Package</h2>
<p>With the Business Package you get a video spokesperson and your script can be up to 180 words. You also get the static or motion background of your choice from our library or we can design a custom background for you. You can have your logo, phone number and/or website displayed during the video. You can also have an intro and outro that includes your website, logo, company name, and an effect.</p>
<p>You can choose music from our library or provide your own, royalty-free music. You can have up to 8 visual elements. That includes up to 6 text sequences, up to 6 images, and 3 video elements. These elements can either come from our library or be provided by you. If you provide these elements they must be royalty-free and you must own the commercial rights.  You can purchase the use of additional elements at a cost of 2 for $125.</p>
<p>In order to keep the cost of our videos low we allow a limited number of revisions. With the Business Package this is 1 revision. </p>
<h5>Click the link below to order the Business Package</h5>
<p align="center"><a href="../order.php"><img src="../images/BusinessPackage.png" width="320" height="143" alt="Business Video Package" id="BusinessPackage" /></a></p>
<p>&nbsp;</p>
