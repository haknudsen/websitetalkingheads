...
<div id="containerExample">
    ...
    <div class="exampleTitle"><a href="custompresentations.php">Custom Presentations</a></div>
        <div class="exampleText"><a href="custompresentations.php"><img src="images/VideoPresentations300.png" width="300" height="270" alt="Custom Video Presentations" id="Custom Video Presentations" onmouseover="onVP()" onmouseout="outVP()"/></a></div>
        
    <?php include ('http://www.websitetalkingheads.com/videopresentations/includes/examples-vp.php'); ?>
        
        <div class="c"></div>
    <div class="exampleFooter"><a href="custompresentations.php">More Examples...</a></div>    
    </div>
    
    <div class="exampleArea">
    <div class="exampleTitle"><a href="powervideos.php">Power Punch Videos</a></div>
    <div class="exampleText"><a href="powervideos.php"><img src="images/PowerPunchtitle300.png" width="300" height="270" alt="Power Punch Videos" id="Power Punch Videos" onmouseover="onPP()" onmouseout="outPP()"/></a></div>
        <?php include ('http://www.websitetalkingheads.com/videopresentations/includes/examples-power.php'); ?>
        <div class="c"></div>
    <div class="exampleFooter"><a href="powervideos.php">More Examples...</a></div>    
    </div>
    <div class="exampleArea">
    <div class="exampleTitle"><a href="virtualsets.php">Virtual Sets</a></div>
    <div class="exampleText"><a href="virtualsets.php"><img src="images/VitualSet300.png" alt="Virtual Sets" width="300" height="270" id="Virtual Sets" onmouseover="onVS()" onmouseout="outVS()" border="0"/></a></div>
    ...
    <div class="exampleText"><a href="../whiteboard/index.php"><img src="images/Whiteboard300.png" width="300" height="270" alt="Custom Whiteboard Videos" id="Custom Whiteboard Videos" onmouseover="onWV()" onmouseout="outWV()"/></a></div>
        ...
        <div class="c"></div>
        <div class="exampleFooter"><a href="http://www.websitetalkingheads.com/whiteboard/index.php">More Examples...</a></div>    
    </div>
    <div class="exampleArea">
