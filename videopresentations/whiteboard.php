...
<div id="threehundred">Whiteboard Videos</div>
<div id="centeredvideo">	<iframe width="640" height="360" src="http://www.youtube.com/embed/NiCdoZ_7kcA?rel=0" frameborder="0" allowfullscreen></iframe>

</div>
<h2>Why Whiteboard Video</h2>
 <div id="whiteboardright">
  <iframe width="320" height="180" src="http://www.youtube.com/embed/gCU4N2IkD90?rel=0" frameborder="0" allowfullscreen></iframe><br />
 FM Insurance
 </div>
<div id="whiteboardleft">
<p>Dummy text is text that is used in the publishing industry or by web designers to occupy the space which will later be filled with 'real' content. This is required when, for example, the final text is not yet available. Dummy text is also known as 'fill text'. It is said that song composers of the past used dummy texts as lyrics when writing melodies in order to have a 'ready-made' text to sing with the melody. Dummy texts have been in use by typesetters since the 16th century.
     ...
     Dummy text is also used to demonstrate the appearance of different typefaces and layouts, and in general the content of dummy text is nonsensical. </p>
