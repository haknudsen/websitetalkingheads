...
<title>Website Talking Heads - Static Backgrounds</title>
<!-- InstanceEndEditable -->
...
<div id="container">
  ...
  <div id="960wide">
    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="960" height="600" id="FlashID" title="Static Background Demo">
      <param name="movie" value="staticbackgrounds.swf" />
      ...
      <!--[if !IE]>-->
      <object type="application/x-shockwave-flash" data="staticbackgrounds.swf" width="960" height="600">
        <!--<![endif]-->
        <param name="quality" value="high" />
        <param name="wmode" value="opaque" />
        <param name="swfversion" value="9.0.45.0" />
