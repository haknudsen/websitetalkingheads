    ...
    <div class="row">
      <div class="col-lg-6 col-sm-6 center-block">
        <div class="player-dark img-box">
          <video preload="auto" loop volume="1" id="video_2" poster="https://s3-us-west-2.amazonaws.com/thevideospokesperson/examples/Whiteboard+Demo.jpg"  data-toggle="tooltip" title="<?=$keyword?> Animation Example">
            <source src="https://s3-us-west-2.amazonaws.com/thevideospokesperson/examples/Whiteboard+Demo.mp4" type="video/mp4">
...
<section class="content-section-a">
  <div class="container space">
    <div class="row">
      ...
      <div class="col-lg-6 col-sm-6 center-block">
        <div class="player-dark img-box">
          <video preload="auto" loop volume="0.7" id="video_1" poster="https://s3-us-west-2.amazonaws.com/thevideospokesperson/WhyVideo/Collaboration+vs+Survey.png" data-toggle="tooltip" title="<?=$keyword?> Collaboration Example">
