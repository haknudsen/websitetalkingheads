...
<head>
    ...
    <meta content="Talking Heads can explain your product, service or procedure in a Blackboard Video! Our Animated Blackboard Videos powerfully expain your product or service step-by-step, and keep your viewers' attention! Whether you can call it a Sketch Video, Chalkboard Video, Hand Drawing Video, Whiteboard Animation, or Animated Explainer Video Talking Heads&reg; will make the best video for you!" name="description">
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-6">
                    ...
                    <h2 class="section-heading">Professional <?=$keyword?>
					 Video</h2>
                    <p class="lead"> <?=$keyword?> Videos created by a Professional Video Production company can increase your sales and close rates.</p>
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?=$keyword?>
                        Videos.<br> It's Time We Talk about your Video Solution.
                    </div>
                </div>
                <div id="content"></div>
            </div>
    ...
    <section class="content-section-a">
        <div class="row">
            <div class="col-lg-6">
                <div class="short-content">
                    ...
                    <div class="row space">
                        ...
                        <div class="col-md-8">
                            <p>The very best scripts come from a collaboarative process. You understand your company. We understand language, impact and inspiration. Integrated, we are unstoppable.</p>
                            <hr class="section-heading-spacer">
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    <div class="row space">
                        ...
                        <div class="col-md-8">
                            <p>We have developed countless
                                <?=$keyword?>
                                Videos for some of the largest business in the world. They trust us to produce an excellent video that will affect your consumers.</p>
                            <hr class="section-heading-spacer">
                            <div class="clearfix"></div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6">
                ...
                <h3>Blackboard Video</h3>
                <p> In Blackboard as well as Chalboard video rather than revealing the images on a Whiteboard the video is made to mimic a person drawing on a Blackboard or Chalkboard. These Videos can be found in various styles. Though the design can depend upon the artist's private style, they will try to look like something that would be drawn on a chalkboard/blackboard. The <a href="http://www.whiteboard.video/Best-Whiteboard-Videos/" title="Best Blackboard Style">Best Blackboard Style</a> Videos are custom made.</p></div>
        </div>
