...
function wthplayer() {
	...
	iPhoneWidth = "144",//When the above happens, the witdh of the image
        width = "144", //video width
        ...
        divTop= "15",
        bottom= "auto",
        centeroffset= "-80",//if centering on page negative numbers are left and positive numbers are right
