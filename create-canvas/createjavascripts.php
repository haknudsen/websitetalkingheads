		...
		<form id="form1" name="form1" method="post" action="createjavascripts2.php">
			...
			<div class="row five-down">
				...
				<div class="col-md-9 col-md-offset-2">
					...
					<div class="col-md-2">Device Width</div>
					<div class="col-md-9">
						<input name="deviceWidth" type="text" id="deviceWidth" value="0"/>Don't show on devices less than this width</div>
			</div>
			<hr>
			<div class="row five-down">
				...
				<div class="col-md-9">
					...
					<strong>Defaults: 1/2 body is 320 full and 3/4 body is 200</strong>
				</div>
			</div>
			<div class="row five-down">
				...
				<div class="col-md-9">
					...
					<strong>Defaults:  1/2 body is 320 full and 3/4 body is 384</strong>
				</div>
			</div>
			<br/>
			<div class="row five-down">
			...
			<div class="row five-down">
				...
				<div class="col-md-9">
					...
					<strong>Remember do not add px at the end of numbers.</strong>
				</div>
			</div>
			<div class="row five-down">
