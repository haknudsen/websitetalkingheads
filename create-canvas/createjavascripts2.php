...
$datatowrite = '// Copyright 2017 Website Talking Heads
//Version 1.2.1
// JavaScript Document
...
function wthplayer() {
	...
	device = "' . $device .'", //Display Talking Head On Devices
...
<section class="black thin create-files">
  <form id="form1" name="form1" method="post" action="https://www.websitetalkingheads.com/create-canvas/createzip.php">
