...
?>
    <? echo '<h2><a href="http://www.websitetalkingheads.com/create-canvas/' . $directory . '" target="_blank">Demo 1</a></h2>'; ?>
    <?
if ($numberofvideos > 1){
	for ($f2 = 2; $f2 <= $numberofvideos; $f2++) {
	echo '<h2><a href="http://www.websitetalkingheads.com/create-canvas/' . $directory . '/index' . $f2 . '.html" target="_blank">Demo ' . $f2 . '</h2></a><br />';
	}
}
?>
