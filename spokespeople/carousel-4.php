...
<head>
<meta charset="utf-8">
<title>Talking Heads | Professional Spokespeople|Men</title>
...
<link rel="stylesheet" type="text/css" href="css/skin_modern_silver.css"/>
...
<section class="talking_heads_carousel">
  ...
  <ul data-cat="Category one">
    <?php include ("includes/carousel-4.php");?>
  </ul>
  </div>
</section>
...
<script>
			FWDU3DCarUtils.onReady(function(){
				var carousel = new FWDUltimate3DCarousel({
					...
					carouselWidth:940,
					carouselHeight:460,
					skinPath:"load/specialty",		
					//main settings
					backgroundColor:"#CCDDFF",
					backgroundImagePath:"load/specialty/background.png",
					thumbnailsBackgroundImagePath:"",
					scrollbarBackgroundImagePath:"load/specialty/scrollbarBackground.png",
