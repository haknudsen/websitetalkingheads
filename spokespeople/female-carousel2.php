...
<head>
    <meta charset="utf-8">
    <title>Talking Heads | Female Spokesperson Carousel 2</title>
    ...
    <meta name="description" content="In this display you will find our top Spokeswomen that you can use for Website Spokesperson, Video Presentations, Greenscreen Video and much more...Choose from our large selection of Professional Video Spokespeople.   Contact us now to learn more.">
    ...
    <body>
        ...
        <?php include ('carousellinks.php'); ?>
        <section class="container-fluid">
            <h1>Spokeswomen 2nd Carousel</h1>
            ...
            <section class="talking_heads_carousel">
                ...
                <div id="carouselData" style="display: none;">
                    ...
                    <ul data-cat="Category one">
                        <?php include ("includes/carousel-2.php");?>
                    </ul>
                </div>
            </section>
        </section>
