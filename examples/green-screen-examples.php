...
if(!$xml=simplexml_load_file('https://www.websitetalkingheads.com/examples/examples-green-screen.xml')){
    trigger_error('Error reading XML file',E_USER_ERROR);
}
$location = 'https://www.websitetalkingheads.com/examples/Images/';
$x=1;
