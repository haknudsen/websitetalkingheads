...
<head>
    <meta charset="utf-8">
    <meta name="keywords" content="Video Scribe,Sketch Videos,Whiteboard Video, Animation, Explainer Video, Video Scribe, Hand Drawing Video, Chalkboard Video, Online Spokesperson, Video Spokesperson, Website Talking Heads, Website Actor, Website Video, Virtual Spokesperson, Spokesperson, Video Presenter, Website Presenter, Website Spokesperson">
    <meta name="description" content="At Talking Heads we work with you to create the best sketch video for your company. We focus on supercharged messages utilizing a video scribing style whiteboard commercials that triggers focus and engagement That's where we come in. We create high impact, exciting whiteboard scribing VIDEOS that explain your product, service, software or business.">
    <meta name="robots" content="index, follow">
    <meta name="author" content="WebsiteTalkingHeads.com">
    <title>Video Scribe|Talking Heads</title>
    ...
    <link rel="stylesheet" type="text/css" href="../../explanationvideo/css/style.css"/>
    <link href="../../explainer-video/css/example-vp.css" rel="stylesheet" type="text/css"/>
  ...
  <![endif]-->
    <link href="../../explanationvideo/css/fluid.css" rel="stylesheet" type="text/css"/>
...
<body>
    <section class="wrap">
        <div class="header">
            <div class="logo"><a href="../../videopresentations/index.php"></a>
            </div>
            <div class="header-right">
                <div class="nav"><a href="../../videopresentations/index.php">Home</a> | <a href="https://www.websitetalkingheads.com/videopresentations/animation.php">Animation</a> | <a href="../../contact.php">Contact</a> </div>
                <div class="phone"><a href="tel://801-748-2281" title="Give us a call.">1-801.748.2281</a>
                </div>
            </div>
        </div>
    </section>
    <section class="whiteboard-demo">
        <div class="row">
            <div class="col-md-7" id="video-holder">
                <div class="banner-text">Stunning Video Scribe Style Videos, Video Doodling, video scribing!</div>
	...
	<div class="row">
		<div class="col-md-2">
			<div class="award">
				<a href="#" data-toggle="tooltip" title="#1 in Video Production"> <img class="img img-responsive seal" src="../../images/video-production-seal.png"  alt="Best in Video Production" /> </a>
				<h4 class="text-center no-margin">#1 Video Production</h4>
			</div>
		</div>
		<div class="col-md-8">
		...
		<div class="col-md-2">
			<div class="award">
				<a href="https://www.topseos.com/rankings-of-best-virtual-spokesperson-companies" data-toggle="tooltip" title="#1 in Video Spokesperson"><img class="img img-responsive seal" src="../../images/video-spokesperson-seal.png"  alt="Best in Video Spokesperson"  /></a>
				<h4 class="text-center no-margin">#1 Video Spokesperson</h4>
			</div>
		</div>
	</div>
</div>
    ...
    <section class="wrap">
        ...
        <div class="content">
            <div class="banner-bottom-text">Video Scribe Videos, Whiteboard videoscribe Animation Videos, video scribe whiteboards, Sketch and Doodle Videos.</div>
            <div class="content-text">Obviously, not all video scribe style videos are alike, so, we work with you to create the best sketch video for your company. We focus on supercharged messages utilizing a video scribing style whiteboard commercials that triggers focus and engagement That's where we come in. We create high impact, exciting whiteboard scribing VIDEOS that explain your product, service, software or business.</div>
            <div class="examples">
