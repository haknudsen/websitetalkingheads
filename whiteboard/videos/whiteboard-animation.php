...
<head>
    <meta charset="utf-8">
    <meta name="keywords" content="Whiteboard Animation,Video Scribe,Sketch Videos,Whiteboard Video, Animation, Explainer Video, Video Scribe, Hand Drawing Video, Chalkboard Video, Online Spokesperson, Video Spokesperson, Website Talking Heads, Website Actor, Website Video, Virtual Spokesperson, Spokesperson, Video Presenter, Website Presenter, Website Spokesperson">
...
<body>
    ...
    <section class="whiteboard-demo">
        <div class="row">
            <div class="col-md-7" id="video-holder">
                <div class="banner-text">Awesome Whiteboard Animation Videos, Video Sketch Animation, Animated whiteboard!</div>
    ...
    <section class="wrap">
        ...
        <div class="content">
            <div class="banner-bottom-text">Whiteboard Animation Videos,  Animated Whiteboard Videos, Sketch animations, Sketch and Doodle Animation Videos.</div>
            <div class="content-text">Obviously, not all Whiteboard Animation style videos are alike, so, we work with you to create the best sketch video for your company. We focus on supercharged messages utilizing a video scribing style whiteboard commercials that triggers focus and engagement That's where we come in. We create high impact, exciting whiteboard animation VIDEOS that explain your product, service, software or business.</div>
            <div class="examples">
