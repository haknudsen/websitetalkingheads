...
<section class="page-header">
  ...
  <h2 id="SpecialTop">THESE OFFERS EXPIRE Friday,
    <?=$newdate?>
  </h2>
</section>
...
<section class = "featuredactor-special2 center-block">
  <h2>Special #2</h2>
  <h3>Multiple Video Special</h3>
  <div class="specials">
  	<div class="row spacer">
        <div class="col-sm-3"><a href="../order.php"><img src="http://www.websitetalkingheads.com/images/60-sec.png" alt="Video Spokesperson-60 Seconds for $299" id="60-sec"/></a></div>
        <div class="col-sm-3"><a href="../order.php"><img src="http://www.websitetalkingheads.com/images/4x30-sec.png" alt="Video Spokesperson-Four 30 Second videos for $399" id="4x30-sec"/></a></div>
        <div class="col-sm-4"><a href="../order.php"><img src="http://www.websitetalkingheads.com/images/10x30-sec.png" alt="Video Spokesperson-Ten 30 Second videos for $799" id="10x30-sec"/></a></div>
        <div class="col-sm-4"><a href="../order.php"><img src="http://www.websitetalkingheads.com/images/5x60-sec.png" alt="Video Spokesperson-Five 60 Second videos for $799" id="5x60-sec"/></a></div>
    </div>
  </div>
  <div class="c"></div>
</section>
