...
<div class="player-container">
  <div class="player" id="video-player">
    <video autoplay id="Talking_Heads_Video" muted loop poster="wthvideo/<?=$name?>.gif">
      <source src="wthvideo/<?=$name?>.mp4" type="video/mp4">
      Sorry, your browser does not
      support HTML5 video.</video>
    <div class="player-list">
      <div class="control"><i class="fa fa-volume-off" id="muteBtn" title="Mute"></i></div> 
      <div class="control" id="volumcontroller"></div>
      <div class="control"><i class="fa fa-2x fa-play-circle-o " id="playpause" title="Play/Pause"></i></div>
