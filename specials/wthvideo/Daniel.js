...
//Variables for Player
	...
	var actorpic= "Daniel";//Just name,not extension
	var flv= "Daniel";//Just name,not extension
	var h264= "Daniel";//Just name,not extension
	var posterImg= "Daniel";//Just name,not extension.  use a jpg for iOS, if left blank the png will be used.	
...
//add eventlisteners
	...
	eh = document.getElementById('h264FallbackMale');//Play Pause
	eh.addEventListener('mouseover', MalePlayerBarOver, false);
	eh.addEventListener('mouseout', MalePlayerBarOut, false);
