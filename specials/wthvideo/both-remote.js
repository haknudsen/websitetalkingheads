...
path = "http://www.websitetalkingheads.com/specials/wthvideo"; //path to where the files are located
featuredactors();
function featuredactors(){
  ...
  // convert vars to something useful
	  ...
	  playerBarMarginTop, e, div, playerCloseFemale, dv, restartBtnFemale, muteBtnFemale, PlayButtonFemale, h264FemaleFallback, objCSSFemale, body, newImg,child, parent, imgLnkFemale = null;
	  iOS = false;
  ...
  // convert vars to something useful
	  ...
	  platform = navigator.platform,
	  nav = navigator.mimeTypes ["application/x-shockwave-flash"],
	  playerBarMarginTop, e, playerCloseMale, dv, restartBtnMale, muteBtnMale, PlayButtonMale, h264MaleFallback, objCSSMale, body, newImg,child, parent, imgLnkMale = null;
	  iOS = false;
