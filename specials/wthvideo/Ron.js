...
//Variables for Player
	...
	var actorpic= "Ron";//Just name,not extension
	var flv= "Ron";//Just name,not extension
	var h264= "Ron";//Just name,not extension
	var posterImg= "Ron";//Just name,not extension.  use a jpg for iOS, if left blank the png will be used.	
