...
//Variables for Player
	...
	var actorpic= "Jack";//Just name,not extension
	var flv= "Jack";//Just name,not extension
	var h264= "Jack";//Just name,not extension
	var posterImg= "Jack";//Just name,not extension.  use a jpg for iOS, if left blank the png will be used.	
