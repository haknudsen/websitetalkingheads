...
//Variables for Player
	...
	var actorpic= "Renny";//Just name,not extension
	var flv= "Renny";//Just name,not extension
	var h264= "Renny";//Just name,not extension
	var posterImg= "Renny";//Just name,not extension.  use a jpg for iOS, if left blank the png will be used.
