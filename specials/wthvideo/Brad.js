...
//Variables for Player
	...
	var actorpic= "Brad";//Just name,not extension
	var flv= "Brad";//Just name,not extension
	var h264= "Brad";//Just name,not extension
	var posterImg= "Brad";//Just name,not extension.  use a jpg for iOS, if left blank the png will be used.	
