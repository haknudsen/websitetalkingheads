...
function wthplayer() {
    ...
    var responsive = "no", //You must place <div id="wthvideo"></div> inside the div you want the video to be in.
        ...
        actorpic = "<?=$name?>", //Just name,not extension png
        actorGif = "<?=$name?>",
        canvasVideo = "<?=$name?>-Canvas", //Just name,not extension h264
        h264 = "<?=$name?>",
        ...
        iPhoneVideo, clickImage, thplayer, spokespersonImage, thb, thv, PlayerBar, newP, e, playerClose, restartBtn, muteBtn, myVidPlayed, createTH, toPlay, dv, playingS, outputCanvas, theCanvas,
        thc, imgLink = null,
