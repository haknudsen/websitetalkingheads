...
//Variables for Player
	...
	var actorpic= "Katie";//Just name,not extension
	var flv= "Katie";//Just name,not extension
	var h264= "Katie";//Just name,not extension
	var posterImg= "Katie";//Just name,not extension.  use a jpg for iOS, if left blank the png will be used.
