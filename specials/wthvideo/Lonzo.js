...
//Variables for Player
	...
	var actorpic= "Lonzo";//Just name,not extension
	var flv= "Lonzo";//Just name,not extension
	var h264= "Lonzo";//Just name,not extension
	var posterImg= "Lonzo";//Just name,not extension.  use a jpg for iOS, if left blank the png will be used.
// end Vars	
