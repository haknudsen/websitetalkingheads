...
//Variables for Player
	...
	var actorpic= "Jed";//Just name,not extension
	var flv= "Jed";//Just name,not extension
	var h264= "Jed";//Just name,not extension
	var posterImg= "Jed";//Just name,not extension.  use a jpg for iOS, if left blank the png will be used.	
	var inListener = null;
...
myVidPlayed=document.getElementById("videoBoxMale");
...
e.addEventListener('mouseover', PlayerBarMaleOver, false);
e.addEventListener('mouseout', PlayerBarMaleOut, false);
