...
//Variables for Player
	...
	var actorpic= "Derek";//Just name,not extension
	var flv= "Derek";//Just name,not extension
	var h264= "Derek";//Just name,not extension
	var posterImg= "Derek";//Just name,not extension.  use a jpg for iOS, if left blank the png will be used.	
