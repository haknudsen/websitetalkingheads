...
//Variables for Player
	...
	var actorpic= "Maria";//Just name,not extension
	var flv= "Maria";//Just name,not extension
	var h264= "Maria";//Just name,not extension
	var posterImg= "Maria";//Just name,not extension.  use a jpg for iOS, if left blank the png will be used.
// end Vars	
