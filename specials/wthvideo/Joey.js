...
//Variables for Player
	...
	var actorpic= "Joey";//Just name,not extension
	var flv= "Joey";//Just name,not extension
	var h264= "Joey";//Just name,not extension
	var posterImg= "Joey";//Just name,not extension.  use a jpg for iOS, if left blank the png will be used.	
