...
//Variables for Player
	...
	var actorpic= "Robyn";//Just name,not extension
	var flv= "Robyn";//Just name,not extension
	var h264= "Robyn";//Just name,not extension
	var posterImg= "Robyn";//Just name,not extension.  use a jpg for iOS, if left blank the png will be used.
