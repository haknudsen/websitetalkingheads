...
//Variables for Player
	...
	var actorpic= "Julia";//Just name,not extension
	var flv= "Julia";//Just name,not extension
	var h264= "Julia";//Just name,not extension
	var posterImg= "Julia";//Just name,not extension.  use a jpg for iOS, if left blank the png will be used.
// end Vars	
...
function hideDiv() {
	var child= document.getElementById("wthvideo-male");
