...
function wthplayer() {
    ...
    var responsive = "yes", //You must place <div id="wthvideo"></div> inside the div you want the video to be in.
        iPhoneWidth = "200", //When the above happens, the witdh of the image
        ...
        actorpic = "Megan", //transparent gif
        canvasVideo = "Megan-canvas", //Just name,not extension
        h264 = "Megan", //Just name,not extension h264
        ...
        curTime, theParent, actorGif, iPhoneVideo, clickImage, thplayer, spokespersonImage, thb, thv, PlayerBar, newP, playerClose, restartBtn, muteBtn, createTH, toPlay, dv, playingS,
        outputCanvas, theCanvas, thc, imgLink = null,
		myPause = false, 
    ...
    function addListeners() {
            ...
            theParent.addEventListener("click", clickHandler, false);
            ...
            function clickHandler(e) {
                    if (e.target !== e.currentTarget) {
						console.log(e.target.id);
                                if (document.getElementById("click-to-play")) {
                                    document.getElementById("click-to-play").parentNode.removeChild(document.getElementById("click-to-play"));
                                }
                        if (myPause === true && thplayer.paused) {
                            if (e.target.id === "talkingCanvas" || "click-to-play" || "spokespersonImage") {
                                goStart();
                            }
                        }
                        else {
    ...
    function startBtnCreate() {
        ...
        if (isDevice) {
            ...
            if (curTime === null) {
                ...
                theParent.appendChild(startBtn);
            }
        }
    ...
    function iPhoneCreate() {
        ...
        iPhoneVideo.id = "talkingheadIPhone";
        ...
        thplayer = document.getElementById("talkingheadIPhone");
    }
