...
function wthplayer() {
    ...
    var responsive = "no", //You must place <div id="wthvideo"></div> inside the div you want the video to be in.
        ...
        divTop = "290",
        bottom = "auto",
        centeroffset = "-250", //if centering on page negative numbers are left and positive numbers are right
        ...
        curTime, theParent, actorGif, iPhoneVideo, clickImage, thplayer, spokespersonImage, thb, thv, PlayerBar, newP, playerClose, restartBtn, muteBtn, createTH, dv, playingS, outputCanvas, theCanvas, thc, imgLink = null,myPause = false, 
...
//------------------------Go Stop Go listener
            ...
            function timeUpdate() {
                ...
                if (theCurrentFrame >= 320 && theCurrentFrame <= 330) {
    ...
    function iPhoneCreate() {
        ...
        btnImg.id = "videoBtn";
        btnImg.src = hBtn;
        btnImg.style.width = (iPhoneWidth / 2) + "px";
        btnImg.style.left = ((iPhoneWidth - iPhoneWidth / 2) / 2) + "px";
        btnImg.style.top = (height - 70) + "px";
