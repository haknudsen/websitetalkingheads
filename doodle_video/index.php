...
<meta name="description" content="Talking Heads can explain your product, service or procedure in an Drawing Video! Our Animated Drawing Videos powerfully expain your product or service step-by-step, and keep your viewers' attention!  Whether you can call it a Sketch Video, Chalkboard Video, Hand Drawing Video, Whiteboard Animation, or Animated Explainer Video Talking Heads&reg; will make the best video for you!">
<meta name="author" content="WebsiteTalkingHeads.com">
<title>Talking Heads®|<?=$keyword?></title>
...
<section class="container">
  <div class="row text-center space">
    ...
    <div class="col-md-4"> <i class="fa fa-gift fa-5x blue" aria-hidden="true"></i>
      ...
      <p><?=$keyword?> Video causes a dopamine rush. This increases the viewers focus, memory, and enjoyment. Your cients will watch your <?=$keyword?> Video.  We like it! We REALLY like it!</p>
    </div>
  ...
  <div class="container space">
    <div class="row">
      <div class="col-lg-6 col-sm-6">
        ...
        <h2 class="section-heading">Professional <?=$keyword?> Video</h2>
        <p class="lead">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						Call <span class="white"><a class="phone-header" href="tel://801-748-2281" title="Give us a call.">801-748-2281</a></span> to learn why Fortune 100’s, startups, small and mid-size businesses trust Talking Heads® with their <?=$keyword?>Videos. "It's Time We Talk" about your Video Solution.
					</div>
				</div>
				<div id="content"></div>
			</div>
