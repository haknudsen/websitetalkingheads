...
<head>
	...
	<meta name="description" content="Talking Heads can explain your product, service or procedure in an Drawing Animation Video! Our Animated Drawing Videos powerfully expain your product or service step-by-step, and keep your viewers' attention!  Whether you can call it a Sketch Video, Chalkboard Video, Hand Drawing Video, Whiteboard Animation, or Animated Explainer Video Talking Heads&reg; will make the best video for you!">
	...
	?>
	<title>
		<?=$keyword?>Video|Talking Heads®</title>
...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header"> <a class="navbar-brand" href="https://websitetalkingheads.com/"><img class="img img-responsive" src="../video_for_proposals/img/TalkingHeads-banner.png" alt="Talking Heads® Video"/></a> </div>
			<div class="navbar navbar-text slogan"><strong>It's Time We Talk</strong>
			</div>
		...
		<div class="jumbotron">
			<div class="row space">
				<h1 class="text-center">
					<?=$keyword?>: The Icing on the Cake!</h1>
				<h2 class="text-center grey">Learn how we make the best <?=$keyword?> today.</h2>
			</div>
	...
	<section class="container">
      ...
      <p>Scientific studies show our brains like watching a hand draw. We are pulled in and can’t take our eyes off.  Have a <?=$keyword?> created for your Clients today.</p>
    </div>
    <div class="col-md-4 "> <i class="fa fa-gift fa-5x blue " aria-hidden="true "></i>
      <h3>Candy for the Brain</h3>
      <p>
        <?=$keyword?>
        causes a dopamine rush. This increases the viewers focus, memory, and enjoyment. Your cients will watch your <?=$keyword?>.  We like it! We REALLY like it!</p>
    </div>
  ...
  <div class="container space ">
    <div class="row ">
      <div class="col-lg-6 col-sm-6 ">
        ...
        <h2 class="section-heading ">Professional Video <?=$keyword?></h2>
        <p class="lead ">
          <?=$keyword?> Videos created by a Professional Video Production company can increase your sales and close rates.</p>
      ...
      <div class="col-lg-6 col-sm-6 center-block ">
        <div class="embed-responsive embed-responsive-16by9 ">
							<iframe class="embed-responsive-item " src="https://websitetalkingheads.com/ivideo/example_video.php?mute=false&autostart=false&video=Collaboration vs Survey&color=111111 " scrolling="no "></iframe>
						</div>
		</div>
		</div>
		</div>
	...
	<section class="content-section-b ">
		<div class="container space ">
			<div class="row ">
				<div class="col-lg-6 col-sm-6 center-block ">
        <div class="embed-responsive embed-responsive-16by9 ">
							<iframe class="embed-responsive-item " src="https://websitetalkingheads.com/ivideo/example_video.php?mute=false&autostart=false&video=Thing A Ma Bob Animation Example&color=111111 " scrolling="no "></iframe>
						</div>
				</div>
				<div class="col-lg-6 col-sm-6 ">
					<div class="clearfix "></div>
	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				...
				<?=$keyword?>Videos. "<span class="thin">It's Time We Talk</span>" about your Video Solution.
				</div>
			</div>
			<div id="content"></div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12"> <img class="center-block" src="../proposals/images/TalkingHeads-small.png" width="200" height="84" alt="Talking Heads Video Logo"/>
					<p class="copyright text-muted small text-center">Copyright &copy;
						<?php echo date("Y")?> WebsiteTalkingHeads.com. All Rights Reserved</p>
				</div>
			</div>
		</div>
	</footer>
