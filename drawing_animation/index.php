		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container-fluid">
				...
				<div class="nav navbar-nav navbar-right">
					<h3 class="phone white">
						<a href="tel://801-748-2281" title="Give us a call.">801-748-2281</a>
					</h3>
				</div>
			</div>
		</nav>
		...
		<section class="container">
			<div class="row text-center space">
				<div class="col-md-4">
					...
					<p>
						Scientific studies show our brains like watching a hand draw. We are pulled in and can’t take our eyes off. Have a <?=$keyword?>
						 created for your Clients today.
					</p>
				</div>
				<div class="col-md-4">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-sm-6 center-block">
						<div class="embed-responsive embed-responsive-16by9">
							<iframe class="embed-responsive-item" scrolling="no" src="../ivideo/Talking_Heads_v4.php?mute=false&autostart=false&video=Collaboration%20vs%20Survey&color=111111"></iframe>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="content-section-b">
			<div class="container space">
				<div class="row">
					<div class="col-lg-6 col-sm-6 center-block">
						<div class="embed-responsive embed-responsive-16by9">
							<iframe class="embed-responsive-item" scrolling="no" src="../ivideo/Talking_Heads_v4.php?mute=false&autostart=false&video=Thing_A_Ma_Bob&color=111111"></iframe>
						</div>
					</div>
					<div class="col-lg-6 col-sm-6">
						<div class="clearfix"></div>
