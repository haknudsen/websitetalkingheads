<?php
		if (file_exists('actors2.rss')){
		unlink('actors2.rss');
		}

$xml_text = '<rss version="2.0" xmlns:media="http://search.yahoo.com/mrss/">
<channel>
	<title>Website Talking Heads Video Spokespeople 2</title>
	<link>http://websitetalkingheads.com/actors/male-carousel.php</link>
...
$file_handler = fopen("actors2.rss", 'a');
