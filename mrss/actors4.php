<?php
		if (file_exists('actors4.rss')){
		unlink('actors4.rss');
		}

$xml_text = '<rss version="2.0" xmlns:media="http://search.yahoo.com/mrss/">
<channel>
	<title>Website Talking Heads Video Spokespeople 4</title>
	<link>http://websitetalkingheads.com/actors/carousel4.php</link>
...
$file_handler = fopen("actors4.rss", 'a');
