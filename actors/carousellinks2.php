  	...
  	<h1 class="contactus">Our Actors</h1>

<div class="carouselheader">
    <nav class="row center-block actors">
           <div class="col-sm-3 actorLink"><a href="male-carousel.php"  title="Male Carousel"  alt="Male Carousel" id="male-carousel" ><h3>Male <div class="linkTitle">Carousel</div></h3></a></div>
           <div class="col-sm-3 actorLink"><a href="female-carousel.php"  title="Female Carousel"  alt="Female Carousel" id="female-carousel" ><h3>Female <div class="linkTitle">Carousel</div></h3></a></div>
           <div class="col-sm-3 actorLink"><a href="female-carousel2.php"  title="Female Carousel 2"  alt="Female Carousel 2" id="female-carousel-2" ><h3>Female <div class="linkTitle">Carousel 2</div></h3></a></div>
           <div class="col-sm-3 actorLink"><a href="carousel4.php"  title="Carousel 4"  alt="Carousel 4" id="carousel 4" ><h3><div class="linkTitle">Carousel 4</div></h3></a></div>
    </nav>
</div>
