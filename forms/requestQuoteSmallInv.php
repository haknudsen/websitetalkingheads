...
<link href="
https://www.websitetalkingheads.com/css/smallInvContactForm.css" rel="stylesheet" type="text/css">
...
<div id="formMessage">test</div>
    <div align="center">
        <input name="submit" type="submit" class="formSubmit" id="submit" onclick="return validate();" submit>
    </div>
