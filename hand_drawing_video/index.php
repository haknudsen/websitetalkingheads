...
<head>
    ...
    <meta content="Talking Heads can explain your product, service or procedure in an Drawing Video! Our Animated Drawing Videos powerfully expain your product or service step-by-step, and keep your viewers' attention! Whether you can call it a Sketch Video, Chalkboard Video, Hand Drawing Video, Whiteboard Animation, or Animated Explainer Video Talking Heads&reg; will make the best video for you!" name="description">
...
<body>
        ...
        <div class="jumbotron">
            ...
            <div class="row center-block">
                ...
                <div class="get-a-quote col-md-4 center-block">
                    ...
                    <div class="formbox">
                        <form accept-charset="utf-8" action="../forms/getInfovTiger.php" class="contactform center-block" enctype="multipart/form-data" id="__vtigerWebForm" method="post" name="whiteboard leads">
                            <fieldset>
                                <input name="__vtrftk" type="hidden" value="sid:a1105c570bd55a2283df9592cfff26c8904dbab9,1443480850"> <input name="publicid" type="hidden" value="0b6d70228937303c28f8d526dab8ef97"> <input name="urlencodeenable" type="hidden" value="1"> <input name="name" type="hidden" value="whiteboard leads"> <input name="cf_1001" type="hidden" value="&lt;?=$pageURL?&gt;">
                                <!-- Text input-->
                                <input name="desination" type="hidden" value="<?php echo $_SERVER[REQUEST_URI];?>">
                                <!-- Text input-->
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input class="form-control input-md" id="lastname" name="lastname" placeholder="Name" type="text">
                                    </div>
                                </div>
                                <!-- Text input-->
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input class="form-control input-md" id="email" name="email" placeholder="Your email" type="text">
                                    </div>
                                </div>
                                <!-- Text input-->
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input class="form-control input-md" id="phone" name="phone" placeholder="Contact Phone" type="text">
                                    </div>
                                </div>
                                <!-- Textarea -->
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <textarea class="form-control" id="description" name="description" placeholder="Your Message"></textarea>
                                    </div>
                                </div>
                                <!-- Button -->
                                <div class="form-group">
                                    <div class="row center-block">
                                        <div class="col-md-12">
                                            <button class="btn btn-custom" id="submit" name="submit">
												<h2 class="need-video">
													I Need Video
												</h2></button>
                    ...
                    <h3 class="text-center text-primary text-large">
							<a class="white" href="tel://801-748-2281" title="Give us a call.">801-748-2281</a>
						</h3>
            ...
            <div class="col-lg-5 col-lg-offset-1">
                <div class="short-content">
                    ...
                    <div class="row space">
                        ...
                        <div class="col-md-8">
                            <p>The very best scripts are a shared process. You understand your organisation. We understand impact, language and inspiration. Integrated, we are unstoppable.</p>
                            <hr class="section-heading-spacer">
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    <div class="row space">
                        ...
                        <div class="col-md-8">
                            <p> We have actually developed countless
                                <?=$keyword?>Videos for a few of the biggest service on the planet. They trust us to develop a fantastic video that will affect their consumers. </p>
                            <hr class="section-heading-spacer">
                            <div class="clearfix"></div>
                        </div>
                    </div>
            ...
            <div class="col-lg-5">
                <div class="row">
                    <div class="col-lg-offset-2 col-lg-8">
                        <img src="../whiteboard/whiteboard-animation-example.jpg" class="img-responsive" alt="Blackboard Animation Video Example">
                    </div>
                </div>
                <h3>Hand Drawing Video</h3>
                <p> In a Hand Drawing Video we show the illistrator's arm drawing the images of the video rather than just revealing the images. These Videos can be found in various styles. Though the design can depend upon the artist's private style, they will try to look like something that would be drawn on a page. </p>
            </div>
    ...
    <section class="content-section-a">
        ...
        <div class="holder">
            <p>We discover what you do, how you do it, and why you do it that way. We understand impact, inspiration and language. We have produced thousands of videos for some of the biggest organisations in the world.  Learn more about our process at <a href="http://www.whiteboard.video/" title="Whiteboard.Video">Whiteboard.video</a></p>
        </div>
        </div>
    </section>
    <section class="video">
