...
$(document).ready(function () {
    ...
    $('#exitpopup').prepend('<img id="popupClose" src="wthvideo/buttons/ExitBtn-full.png" />');
    ...
    function wthplayer() {
        ...
        var responsive = "yes", //You must place <div id="talking-popup"></div> inside the div you want the video to be in.
        ...
        function createVideo() {
            ...
            thv.appendChild(v);
            thplayer = document.getElementById("spokesperson");
        ...
        function createControls() {
            ...
            createTH.id = "muteBtn";
            if (document.getElementById("spokesperson").muted) {
