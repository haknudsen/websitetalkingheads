...
<section class="container">
    ...
    <div class="errortext">
        ...
        <div class="largeText2">
            Sorry for the inconvenience, looks like the page you are looking for isn't where we thought it was. <br />
        Please contact the <a href="mailto:support@websitetalkingheads.com">webmaster</a> so we can correct the error. </div>
        <p>&nbsp;</p>
    </div>
