...
function wthplayer() {
	...
	iPhoneWidth = "288",//When the above happens, the witdh of the image
        ...
        autostart= "onceonlythenmute",//autostart options yes, no, mute, oncethenpic, oncethenmute, onceonlythenpic, onceonlythenmute, and loop
...
//----------------------------------------------------------------------Detect Mobile
    ...
    if (iOS || isAndroid || isMobileDevice !== null) {isDevice = true;}
    if (!isDevice) {
        hVideo = path + "/" + canvasVideo + ".mp4";
    } else {
