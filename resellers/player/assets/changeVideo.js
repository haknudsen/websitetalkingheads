// JavaScript Document
	...
	function playerPlacement(){
		playerPl = document.getElementById('MyPlayer').style;
		systemPlacement = document.getElementById('HTML5system').style
		playerPl.left = (systemPlacement.width - playerPl.width)/2;
		playerPl.top = (systemPlacement.height - playerPl.height)/2;
		echo (systemPlacement);
