...
<div class="contactus">Website Talking Heads Demo System</div>
  ...
  <div id="july4text">NEW!</div>
    <div class="contactus">This is a completely new system designed in HTML5.</div>
  <p>Files updated July 11th 2013. If you have downloaded your files prior to this date, please download the latest version and update. <br />
  Download new reseller demo system <a href="html5download.zip">here:</a></p>
  <div id="contactus">To install</div>
    <ol>
  <li>Download the <a href="html5download.zip">html5download.zip</a> file to your computer.</li>
  <li>Unzip all the files.  You should have an test.php and data.xml then a folder named <strong>assets</strong> with changeVideo.js, player.css, and a bunch of images.</li>
  <li>Upload the files and folder to the folder that you want the demo system in.</li>
  <li>You can now test the system viewing the test.php page in the folder you uploaded the files to(note for the system to work you MUST upload all the files to the right folder).</li>
</ol>
<div id="blueText">You can now customize the player any way that you would like. </div>
<ul>
	<li>The buttons and player background are images in the assets folder, you can replace with any buttons or images that you would like. </li>
...
<div id="blueText">If you need to iFrame the demo system, the address is <a href="http://www.websitetalkingheads.com/resellers/player/test.php">http://www.websitetalkingheads.com/resellers/player/test.php</a></div>
<br />
