...
<link href="../comtek%20-%20Copy/assets/homeplayer.css" rel="stylesheet" type="text/css" />
</head>
<body>
<section class="container">
    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="920" height="460" id="FlashID" title="Reseller Demo">
      <param name="movie" value="../comtek%20-%20Copy/final.swf" />
      ...
      <!--[if !IE]>-->
      <object type="application/x-shockwave-flash" data="../comtek%20-%20Copy/final.swf" width="920" height="460">
        <!--<![endif]-->
        <param name="quality" value="high" />
        <param name="wmode" value="opaque" />
        <param name="swfversion" value="9.0.45.0" />
        ...
        <div class="HTML5system">
          <div id="MyPlayer">
            <video id="videoBox" width="540" height="360" alt="video spokesperson" poster="../comtek%20-%20Copy/assets/poster.png" >
              <source src="http://www.websitetalkingheads.com/videos/Jed.mp4" type="video/mp4">
              Your browser does not support the video tag. </video>
            <div id="videoBoxText">Jed</div>
            <div class="PlayerBar">
              <a href="#" onClick="muteToggle()"><img src="../comtek%20-%20Copy/assets/VolumeBtn.png" alt="Volume" id="muteBtn" class="playerBtn" /></a>
              <a href="#" onClick="playToggle()"><img  id="PlayPauseBtn" src="../comtek%20-%20Copy/assets/PlayBtn.png" alt="Play Pause Button"  class="playerBtn"/></a>
              <a href="#" onClick="restartToggle()"><img  id="RestartBtn" src="../comtek%20-%20Copy/assets/RestartBtn.png" alt="Restart Button"  class="playerBtn"/></a> 
              <a href="#" onClick="closePlayer()" ><img src="../comtek%20-%20Copy/assets/ExitBtn.png" alt="Close Player" id="exitBtn"  class="playerBtn"/></a>
            </div>
          </div>
          <div class="MyPlayerHolder">
            <?php include ('../comtek%20-%20Copy/assets/flashbackup.php'); ?>
          </div>
        </div>
        <!--[if !IE]>-->
      </object>
...
<script src="../comtek%20-%20Copy/assets/changeVideo.js" type="text/javascript"></script>
</body>
</html>