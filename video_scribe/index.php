...
<head>
    ...
    <meta content="We know all organizations are not alike, so, we work with you to make the best video for you! We make highly effective, energizing VIDEOS that clarify your product, website, organization or business." name="description">
    ...
    <section class="content-section-a">
        <div class="row">
            <div class="col-lg-5 col-lg-offset-1">
                <div class="row">
                    <div class="col-lg-offset-2 col-lg-8"> <img src="../whiteboard/whiteboard-animation-example.jpg" class="img-responsive" alt="Whiteboard Animation Example"> </div>
                </div>
            ...
            <div class="col-lg-5">
                <div class="short-content">
                    <div class="row space">
                        <div class="col-md-4 text-center"><i class="fa fa-comments-ofa-5x grey" aria-hidden="true"></i> <br>
                            <h3 class="no-margin">Communication</h3> </div>
                        <div class="col-md-8">
                    ...
                    <div class="row space">
                        <div class="col-md-4 text-center"><i class="fa fa-users fa-5x grey" aria-hidden="true"></i> <br>
                            <h3 class="no-margin">Collaboration</h3> </div>
                        <div class="col-md-8">
                    ...
                    <div class="row space">
                        <div class="col-md-4 text-center"><i class="fa fa-televisionfa-5x grey" aria-hidden="true"></i> <br>
                            <h3 class="no-margin">Creation</h3> </div>
                        <div class="col-md-8">
                            <p>We have produced countless
                                <?=$keyword?>Videos for several of the biggest organisations on the planet. They trust us to develop an excellent video that will affect their clients. </p>
                            <hr class="section-heading-spacer">
                            <div class="clearfix"></div>
                        </div>
                    </div>
    ...
    <section class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-5 col-lg-offset-1">
                ...
                <h3 class="text-center">Whiteboard or Video Scribe</h3>
                <p>Definitely, not all whiteboard style videos are alike, so, we work with you to create the best whiteboard video for your business. We focus on supercharged messages utilizing a hand drawn <a href="http://www.whiteboard.video/Animation/" title="whiteboard animation">whiteboard animation</a> that triggers focus and engagement. We create high impact, exciting whiteboard animation VIDEOS that explain your product, service, business or software.</p>
                <p>We will use our years of experience from creating lots of videos for organizations around the globe to really help you achieve your goals. Call us now we would love to obtain your lasting video business.</p>
            </div>
            <div class="col-lg-5">
            <div class="short-content">
                    <div class="row space">
