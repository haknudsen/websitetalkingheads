...
<section title="footer">
    <footer>
        <h2><a href="../contact.php">© Copyright 2007-<?php echo date("Y")?> WebsiteTalkingHeads.com. All Rights Reserved.</a></h2>
    </footer>
</section>
...
<script type="text/javascript">
	...
	document.getElementById('title-reporter').innerHTML = title;
});
</script>