...
<head>
	...
	<meta name="description" content="Custom Whiteboard Videos, Whiteboard Animation Videos, 
Whiteboard Sketch Videos, Hand Drawing Videos, Chalkboard Videos, Animated Whiteboard VideosTalking Heads can create a Whiteboard Video, Animation, Explainer Video, Video Scribe, Hand Drawing Video, Chalkboard Video.  Here you watch examples of these kinds of videos.  Contact us for more information">
	<META NAME="robots" CONTENT="index, follow">
	<title>TalkingHeads | Cool Whiteboard Animation Videos, Sketch videos, Animated Whiteboard Videos</title>
...
<body>
	<script type="text/javascript" src="../forms/js/validate.js"></script>
	<section class="wrap">
		<div class="header">
		...
		<div class="row center-block">
			<div class="col-sm-7 center-block">
				...
				<div class="embed-responsive embed-responsive-16by9  banner-video">
					<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/hZylgJrhGEE?rel=0&autohide=2&showinfo=0" allowfullscreen> </iframe>
				</div>
			</div>
			<div class="col-sm-5 get-a-quote">
	...
	<section class="wrap">
		<div class="content">
			...
			<div class="examples">
				<?php include ('https://www.websitetalkingheads.com/videopresentations/includes/examples-whiteboardFull.php'); ?>
				<div class="c"></div>
			</div>
...
<div class="no-1">
	...
	<img src="../images/video-production-seal.png" alt="Best in Search #1 Video Production" width="320" title="#1 Video Production"/>
