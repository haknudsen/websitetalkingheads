...
<head>
    <meta charset="utf-8">
    <title>Talking Heads|Pros vs Cons of Video Spokesperson</title>
...
<body>
    ...
    <section class="page-header text-center">
        <h1>The Pros and Cons of Getting a Website Spokesperson</h1>
        <h2>Looking for a new way to bring life to your website and generate more interest from those who visit it?</h2>
    </section>
    <section class="alert-info">
        <div class="container">
            <p class="summary">These days, the trend for many is to add videos--but not just any video. We're talking about having an actual virtual spokesperson who will directly convey your message to potential clients. There are many perks to having this addition to your website, but all the same, it is just as important to consider the downsides to it as well. This is especially so if you're a newer business and this is your first attempt at using this particular marketing method.</p>
            <p class="summary">To help you better understand this, we've enumerated some of the things you need to know below.</p>
        </div>
    </section>
    <section class="container margin-25">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="text-uppercase">pros:</h3>
                <ul class="pros-cons">
